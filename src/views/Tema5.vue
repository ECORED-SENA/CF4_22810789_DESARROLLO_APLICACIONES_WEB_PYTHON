        ...
        SlyderA(tipo="b")
          .row.mt-lg-3
            .col-lg-12.col-xl-4.mb-4.mb-md-0
              ...
              p Si es la primera vez dar clic en #[em Sign up here!]  Allí hay que seleccionar la opción #[em Create a Beginner account] y proceder a colocar sus datos para el registro.
